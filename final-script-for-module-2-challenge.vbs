...
'Both yielded the same result (bonus was not done in the draft)
...
For Each ws In Worksheets
    ...
    'Print and format greatest % increase ticker and value
    ws.Range("P2").Value = tickerin
    ws.Range("Q2").Value = greatestincrease
    ws.Range("Q2").NumberFormat = "0.00%"
    
    'Print and format greatest % decrease ticker and value
